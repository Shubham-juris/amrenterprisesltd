import aboutimg from "../../../assets/solution/potential/about.webp";

export default function PontentialWithUs() {
  return (
    <div className="bg-black text-white px-6 md:px-20 py-12">
      <div className="grid md:grid-cols-2 items-stretch gap-10">
        <div>
          <h2 className="text-xl md:text-xl border-b border-gray-500 pb-2 mb-6">
          ...
          <div className="space-y-6 text-gray-300 opacity-65 text-sm md:text-base leading-relaxed">
            ...
            <h2
              ...
              className="text-xl md:text-xl border-b border-gray-500 opacity-100 text-white pb-2 mb-6"
            >
              Our Approach
            </h2>
            <p>
